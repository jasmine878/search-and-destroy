...
describe('Binary Search', () => {
	xit('returns true if target value is in array', () =>{
	...
	it("returns true if array length is one", () => {
    expect(binarySearch(test4, 3)).to.equal(true);
	});
		it("returns true if array length is two", () => {
      expect(binarySearch(test5, 1)).to.equal(true);
		});
		it("returns true if array length is three", () => {
      expect(binarySearch(test6, 2)).to.equal(true);
    });

		it("returns false if array length is one", () => {
      expect(binarySearch(test4, 4)).to.equal(false);
		});
		it("returns false if array length is two", () => {
      expect(binarySearch(test5, 3)).to.equal(false);
			});
		it("returns false if array length is three", () => {
      expect(binarySearch(test6, 5)).to.equal(false);
    });
